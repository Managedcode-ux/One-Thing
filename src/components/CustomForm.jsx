  ...
  return (
    <>
      <h1 className='text-3xl sm:text-6xl font-bold 
        text-center '>What is your "one thing"?</h1>
      <form className='flex ring-4 rounded-md ring-slate-200
       dark:ring-slate-800
       focus-within:ring-teal-600 focus-within:ring-offset-4
       bg-slate-200 ring-offset-slate-200 dark:ring-offset-slate-800
       '
      ...
      >
        <input type="text"
          className='bg-inherit rounded-md font-sans text-slate-800
            ...
            placeholder:text-slate-400 cartel-teal-600 appearance-none w-full'
        ...
        <button
          className='bg-inherit rounded-md font-sans text-slate-800
            py-2 px-6 focus:outline-none focus:text-teal-600 
            hover:text-teal-600'>
